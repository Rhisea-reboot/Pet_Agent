...
struct _tagTtsConfig
{
    ...
    QString refAudioPath;   ///< 参考音频文件路径
    QString promptText;     ///< 参考音频对应的文本
    QString promptLang;     ///< 参考音频语言
    QString textLang;       ///< 合成文本语言
};

/**
 * @brief GPT-SoVITS TTS HTTP 客户端
 *
 * 通过 HTTP POST 请求将文本发送到 GPT-SoVITS API 服务器，
