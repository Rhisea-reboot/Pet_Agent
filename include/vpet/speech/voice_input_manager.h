 ...
 * @brief 按键语音输入管理器
 *
 * 负责录制用户语音、调用 GPT-SoVITS 自带 ASR 脚本，并输出识别文本。
 */
...
private:
    ...
    /**
     * @brief 查找 GPT-SoVITS 根目录
     * @return GPT-SoVITS 根目录；未找到返回空字符串
     */
    QString FindGptSoVitsRootPath() const;
